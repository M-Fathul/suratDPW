    ...
    <div class="container mt-5">
        <div class="pagetitle">
            <div class="mb-3 justify-content-between mx-2">
                <h1>Surat Masuk</h1>
                <a href="/dashboard/surat_masuk/tambah" class="btn btn-primary">Tambah Baru</a>
            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex items-center justify-center gap-2">
                            <a href="/dashboard/surat_masuk/{{$d->id}}/edit" class="mr-2 btn btn-warning">edit</a>
                            <form action="/dashboard/surat_masuk/{{$d->id}}" method="POST">
                                @method('DELETE')
                                @csrf
