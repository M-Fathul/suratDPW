...
<div class="main-container p-5">
    <div class="pd-ltr-20 xs-pd-20-10">
        ...
        <div class="pd-20 card-box mb-20">
            ...
            <form action="/dashboard/surat_masuk/{{($data->id)}}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="pengirim" name="pengirim" placeholder="Pengirim.." value="{{ $data->pengirim }}" />
                </div>
                <div class="form-group">
